...
class ArmDriver(Node):
    ...
    # Arm control instruction:
    # [bicep_actuator_len, forearm_actuator_len, bicep_angle, forearm_angle, base_angle, pitch_angle, roll_angle, finger_velocity, poker_velocity]
