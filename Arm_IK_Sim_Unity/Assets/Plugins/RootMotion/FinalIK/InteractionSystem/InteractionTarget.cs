...
namespace RootMotion.FinalIK {
	...
	public class InteractionTarget : MonoBehaviour {
		...
		private static Color handGizmoColor = new Color(0.2f, 0.5f, 1f);
		private static Color fadedHandGizmoColor = new Color(0.2f, 0.5f, 1f, 0.5f);
        ...
        private void OnDrawGizmos()
        {
	        ...
	        if (SelectionContainsChild())
	        {
		        Gizmos.color = handGizmoColor;
		        DrawChildrenRecursive(this.transform);
	        }
        }
		...
		{
			if (SelectionContainsChild() == false)
			{
				return;
			}
			Gizmos.color = fadedHandGizmoColor;
			DrawChildrenRecursive(this.transform);
		}

		///-///////////////////////////////////////////////////////////
		/// 
        private bool SelectionContainsChild()
        {
	        foreach (Transform selectedTransform in Selection.transforms)
	        {
		        if (selectedTransform == this.transform || selectedTransform.IsChildOf(this.transform))
		        {
			        return true;
		        }
	        }
        ...
        private void DrawChildrenRecursive(Transform t)
        {
	        ...
	        for (int i = 0; i < t.childCount; i++) {
		        ...
		        Gizmos.DrawSphere( t.GetChild(i).position, 0.005f);
